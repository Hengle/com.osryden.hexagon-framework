...
{
    public abstract class HexagonCoordinatesDrawerBase<T> : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            IHexagonCoordinates<T> coordinates = (IHexagonCoordinates<T>)fieldInfo.GetValue(property.serializedObject.targetObject);
